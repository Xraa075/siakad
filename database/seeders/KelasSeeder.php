...
class KelasSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Kelas::create([
            'nama_kelas' => 'D3 TI A',
            'jurusan_id' => 2, // Asumsi ID Jurusan Teknik Informatika
        ...
        Kelas::create([
            'nama_kelas' => 'D3 TI B',
            'jurusan_id' => 2, // Asumsi ID Jurusan Teknik Informatika
            'dosen_nip' => 'DSN002', // Asumsi NIP Dosen Budi Santoso sebagai Wali
            'semester' => 2,
            'jadwal_kuliah_id' => 1, // Asumsi ID JadwalKuliah
        ]);
        ...
        Kelas::create([
            'nama_kelas' => 'D3 SI A',
            'jurusan_id' => 3, // Asumsi ID Jurusan Sistem Informasi
