...
@section('content')
    <div class="container mt-4">
        @if ($departemen)
            <h3 class="mb-2"> Daftar Jurusan (<span>{{ $departemen->nama_departemen }}</span>)</h3>
            <a href="{{ route('admin.departemen.index') }}" class="btn btn-sm btn-outline-secondary mb-3">Kembali ke
                Daftar Departemen</a>
        @else
