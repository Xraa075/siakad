...
@section('content')
    <div class="container mt-4">
        ...
        <a href="{{ route('admin.departemen.create') }}" class="btn btn-success mb-3">Tambah Departemen</a>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.departemen.destroy', $dept->id) }}" method="POST"
                                class="d-inline"
                                onsubmit="return confirm('Apakah Anda yakin ingin menghapus departemen ini? Semua jurusan dan kelas yang terkait akan terhapus juga.');">
                                @csrf
                                @method('DELETE')
